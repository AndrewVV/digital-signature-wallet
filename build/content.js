...
/***/ "./content/class.endorseManager.js":
/*!*****************************************!*\
  !*** ./content/class.endorseManager.js ***!
  \*****************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EndorseManager; });
...
/*#__PURE__*/
function () {
  function EndorseManager() {
    _classCallCheck(this, EndorseManager);
  }

  _createClass(EndorseManager, [{
    key: "perform",
    value: function () {
      var _perform = _asyncToGenerator(
      /*#__PURE__*/
      regeneratorRuntime.mark(function _callee() {
        var endorses, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, endorse;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return this.scrollPageToBottom();

              case 2:
                _context.next = 4;
                return this.scrollPageToMiddle();

              case 4:
                $('.pv-skills-section__additional-skills').click();
                endorses = $('.pv-skill-entity__featured-endorse-button-shared[aria-pressed="false"]');
                ...
                for (_iterator = endorses[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                  endorse = _step.value;
                  endorse.click();
                  this.clickSubmit();
                  this.clickVeryGood();
    ...
    key: "clickVeryGood",
    value: function () {
      var _clickVeryGood = _asyncToGenerator(
      /*#__PURE__*/
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", new Promise(function (resolve) {
                  var veryGoodBtn = $('#endorsement-followup-proficiency-1-Performance');
                  veryGoodBtn.click();
                  setTimeout(function () {
                    resolve(true);
                  }, 1500);
      ...
      function clickVeryGood() {
        return _clickVeryGood.apply(this, arguments);
      }

      return clickVeryGood;
    }()
  }, {
    key: "clickSubmit",
    value: function () {
      var _clickSubmit = _asyncToGenerator(
      /*#__PURE__*/
    ...
    key: "scrollPageToMiddle",
    value: function () {
      var _scrollPageToMiddle = _asyncToGenerator(
      /*#__PURE__*/
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                return _context4.abrupt("return", new Promise(function (resolve) {
                  var thirdOfHeight = Math.floor(document.body.clientHeight / 3);
      ...
      function scrollPageToMiddle() {
        return _scrollPageToMiddle.apply(this, arguments);
      }

      return scrollPageToMiddle;
    }()
  }, {
    key: "scrollPageToBottom",
    value: function () {
      var _scrollPageToBottom = _asyncToGenerator(
      /*#__PURE__*/
      ...
      function scrollPageToBottom() {
        return _scrollPageToBottom.apply(this, arguments);
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _widget_class_widgetManager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./widget/class.widgetManager.js */ "./content/widget/class.widgetManager.js");

var WidgetManager = new _widget_class_widgetManager_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
$(function () {
...
/***/ "./content/listener/class.locationListener.js":
/*!****************************************************!*\
  !*** ./content/listener/class.locationListener.js ***!
  \****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LocationListener; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function LocationListener() {
    _classCallCheck(this, LocationListener);
  }

  _createClass(LocationListener, [{
    key: "onHrefChanged",
    value: function onHrefChanged(callback) {
...
/***/ "./content/widget/class.widgetManager.js":
/*!***********************************************!*\
  !*** ./content/widget/class.widgetManager.js ***!
  \***********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return WidgetManager; });
/* harmony import */ var _widget_svelte__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./widget.svelte */ "./content/widget/widget.svelte");
/* harmony import */ var _listener_class_locationListener_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../listener/class.locationListener.js */ "./content/listener/class.locationListener.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var LocationListener = new _listener_class_locationListener_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
var PROFILE_PAGE_PATH = 'www.linkedin.com/in';
...
function () {
  ...
  _createClass(WidgetManager, [{
    ...
    value: function initWidget() {
      ...
      var wrapper = $.parseHTML('<div style="z-index: 102; position: absolute" class="widget-prepend-block"></div>');

      if (window.location.href.includes(PROFILE_PAGE_PATH)) {
        this.appendWidget(wrapper);
      }

      LocationListener.onHrefChanged(function (locationHref) {
        if (locationHref.includes(PROFILE_PAGE_PATH)) {
          _this.appendWidget(wrapper);
        } else {
          $(wrapper).remove();
        }
      });
    ...
    key: "appendWidget",
    value: function appendWidget(wrapper) {
      $(document.body).prepend(wrapper);
      var widget = new _widget_svelte__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			button.textContent = "Endorse Skills";
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(button, "class", "endorse-widget-button svelte-x666mp");
			Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["attr"])(div, "class", "endorse-master-widget svelte-x666mp");
			dispose = Object(svelte_internal__WEBPACK_IMPORTED_MODULE_0__["listen"])(button, "click", ctx.endorseProfile);
		},
...
function instance($$self) {
	const EndorseManager = new _class_endorseManager_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
/***/ "./content/widget/widget.svelte.css":
/*!******************************************!*\
  !*** ./content/widget/widget.svelte.css ***!
  \******************************************/
/*! no static exports found */
...
/***/ 5:
/*!**************************************************!*\
  !*** multi @babel/polyfill ./content/content.js ***!
  \**************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

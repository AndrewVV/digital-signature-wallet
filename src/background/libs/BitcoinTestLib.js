...
const BTCDECIMALS = 8;
class BitcoinTestLibClass{
    constructor(wallet){
        console.log('Bitcoin Testnet Active');
    ...
    sendTransaction(to,amount,fee){
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                let url = `https://api.blockcypher.com/v1/btc/test3/txs/push?token=${token}`
    ...
    createAddress(){
        return new Promise(async(resolve,reject)=>{
            try{
                let result = "placeholder address";
...
module.exports = BitcoinTestLibClass;
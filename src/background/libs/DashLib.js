...
class DashLibClass{
    ...
    getBalance(raw=true){
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                let url = `https://chain.so/api/v2/get_address_balance/DASH/${address}`
    ...
    sendTransaction(to,amount,fee){
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                let url = `https://chain.so/api/v2/send_tx/DASH`
    ...
    listUnspent(address){
        return new Promise(async(resolve,reject)=>{
            try{
   	            this.validator.validateBtcAddress(address);
   	            let url = `https://chain.so/api/v2/get_tx_unspent/DASH/${address}`
